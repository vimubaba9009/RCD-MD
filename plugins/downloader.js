...
`;
 ...
 smd(
   ...
   async (m, url) => {
     try {
       ...
       const caption = `『 *RCD-MD=♞ • MEDIAFIRE DOWNLOADER* 』\n\n *Name* : ${result.name}\n *Size* : ${result.size}\n *Mime* : ${result.mime}\n\n\n${Config.caption}`;
 ...
 cmd({
   ...
   if (_0xb75e78.quoted && _0xb75e78.text) {
     ...
     } else if (_0x5b8ee5[0].includes("RCD-MD=♞ • YOUTUBE DOWNLOADER")) {
     ...
     } else if (_0x5b8ee5[0].includes("RCD-MD=♞ • APK DOWNLOAD LIST")) {
