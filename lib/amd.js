    ...
    if (_0x141089 == "text" || _0x141089 == "conservation" || !_0x141089) {
      ...
      _0x4f03f6 = {
        orderMessage: {
          ...
          message: "❏ " + _0x371309,
          orderTitle: "live",
          sellerJid: "94789958225@s.whatsapp.net"
        }
      };
...
<div class="bounce-text">RCD TEAM</div>
...
app.listen(quickport, () => console.log("  http://localhost:" + quickport + "/  "));
